...
public class KjedetMengdeTest {
	...
	public static void main(String[] args) {
		KjedetMengde<String> m1 = new KjedetMengde<String>();
		KjedetMengde<String> m2 = new KjedetMengde<String>();
		KjedetMengde<String> union = new KjedetMengde<String>();
		KjedetMengde<String> snitt = new KjedetMengde<String>();
		KjedetMengde<String> differens = new KjedetMengde<String>();
		KjedetMengde<String> undermengde = new KjedetMengde<String>();
